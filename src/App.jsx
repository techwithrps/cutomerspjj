  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] text-slate-900 flex flex-col font-sans selection:bg-[#0284c7] selection:text-white">
      ...
      <div className="fixed bottom-5 right-4 sm:right-6 z-50">
        <button
          type="button"
          onClick={() => alert("SPJ WhatsApp Bot service is being initialized. Number integration will be active shortly.")}
        ...
        >
          ...
          <span className="hidden sm:inline font-bold">Chat on WhatsApp Bot</span>
